...
Atuo com testes manuais e automatizados, validação de regras de negócio, análise de cenários críticos e prevenção de falhas em sistemas.

Tenho experiência na criação de cenários de teste, execução E2E, validação de integrações e acompanhamento de bugs, sempre com foco na experiência do usuário e estabilidade do produto.
